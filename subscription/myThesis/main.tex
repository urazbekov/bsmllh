...
\begin{table}[bp]
\caption{Parameters of imaginary part of the optical potential for calculating elastic scattering cross section $\alpha$ + $^9$Be. The $a_w$ parameter for all energies is 0.97 fm
}
\label{abe_tab1}
\centering
\footnotesize
...
% \usepackage{multirow}
\begin{table}[bp]
\caption{Parameters of the optical potentials for calculations using the distorted waves and channel coupling methods}
\label{abe_tab2}
\centering
\footnotesize
