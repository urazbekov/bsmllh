...
In Figures \ref{fig:be0_the3D}, \ref{fig:li0_the3D} and \ref{fig:he0_the3D} the correlation density of the three-body wave function are illustrated in the 3d-Plot for $^6$He,  $^6$Li and $^9$Be. For purpose of good visibility the contour -plot are given along.
