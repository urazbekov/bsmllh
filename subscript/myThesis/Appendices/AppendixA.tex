...
$\bullet~$ It would be useful also note a coupling between two spherical hyper harmonics kind of (see \cite{suzuki1998stochastic},  p.   269)
\begin{equation}
...
$\bullet~$ The modified spherical Bessel function may be expressed as follows (see \cite{suzuki1998stochastic},  p.  98)
\begin{equation}
...
i_{l}(|w|y)
\end{equation*}
 has the analytic form in the following (see \cite{suzuki1998stochastic},  p.  270)
\begin{equation}
\mathcal{I}(n,~l,~v,~|w|) = 
...
i_{l}(|\rho|xy)
\end{equation}
may be expressed explicitly as follow (see \cite{suzuki1998stochastic},  p.  271)
\begin{align}
