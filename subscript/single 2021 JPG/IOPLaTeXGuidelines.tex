...
\title[Single particle, cluster, and collective excitation models 
of $^{13}$C ]
{
Single particle, cluster, and collective excitation modes 
of $^{13}$C below $E_{x}$=10 MeV
}

\author{ B A Urazbekov$^{1,2}$, 
N T Burtebayev$^2$, 
A S Denikin$^{1,2}$, 
D M Janseitov$^{1,2,3}$,
Zh Kerimkulov$^2$,
...
\address{$^1$ Joint Institute for Nuclear Research, Joliot-Curie Street, Dubna 141980, Russia}
\address{$^2$ Institute of Nuclear Physics, Ibragimov Street, Almaty 050032, Kazakhstan}
\address{$^3$ Kazakh National University, Al-Farabi Street, Almaty 050040, Kazakhstan}
...
An analyses for the $d + ^{13}\mathrm{C}^*$ nuclear reactions are carried out for the $J^\pi$ excitation levels of $^{13}\mathrm{C}^*$: $\frac{1}{2}^+, \frac{3}{2}^-, \frac{5}{2}^+_2, \frac{5}{2}^-, \frac{1}{2}^-$, and $\frac{3}{2}^-$. 
The first excitation band, $\frac{1}{2}^+$, having a nature of single particle excitation, is used for extracting the Spectroscopic Amplitudes of $\langle ^{12}\mathrm{C} | ^{13}\mathrm{C} \rangle$ 
and $\langle ^{12}\mathrm{C} | ^{13}\mathrm{C}^*  ~\frac{1}{2}^+ \rangle$ overlaps.
A comparison of taken spectroscopic informations with the values by other authors are presented. The deformation parameters of the rest excited states are listed.
\end{abstract}
\vspace{2pc}
\noindent{\it Keywords}: nuclear reactions, halo structure, coupled channels, inelastic scattering \\
%
...
\begin{figure}
\center
\includegraphics[scale=1]{spectra}% Here is how to import EPS art
\caption{\label{fig:spectra} The spectra of registered deuteron particles at the angle of 38$^\circ$ as the result of $d~+~^{13}$C nuclear reaction.}
\end{figure}
...
database entries used to generate these examples can be
